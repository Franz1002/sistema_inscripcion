                        ...
                        <div class="col-sm-12">
                            <div class="card">
                                <div class="card-header">
                                    ...
                                    <button class="btn waves-effect waves-light btn-primary" type="button" onclick="openModalPrekinder();"> <i class="fas fa-plus-circle"></i>Inscribir estudiante</button>
                                            ...
                                            <div class="tile">
                                                <div class="tile-body">
                                                    <div class="table-responsive">
                                                        <table class="table table-hover table-bordered" id="tablePrekinders">
...
<!-- Modal -->
<div class="modal fade" id="modalNuevoInsPrekinder" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="card">
                <div class="card-block">
                    <form class="form-material" method="post" id="modalFormInsPrekinder" name="modalFormInsPrekinder">
                        <div class="row">
                            <div class="form-group col-sm-12">
                                <input type="hidden" id="idInscripcion" name="idInscripcion" value="1" required>
                                <label>Código RUDE del estudiante</label>
                                <input type="text" name="listRude" id="listRude" class="form-control" required>
                            </div>
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <div class="col-sm-12">
                                <select class="form-control" data-live-search="true" name="listAula" id="listAula" required="">
                ...
                <div class="text-center">
                    <button class="btn btn-success waves-effect waves-light" type="button" onclick="registrarEstPrekinder(event);" id="btnGuardarForm"><i class="fa fa-check" aria-hidden="true"></i><span id="btnText">Guardar</span></button>&nbsp;&nbsp;&nbsp;
