<?php
class KinderModel extends Mysql
{
    public function __construct()
    {
        parent::__construct();
    }
    public function selectEstKinder()
    {
        $sql = "SELECT i.idinscripcion,i.estudianteid,e.rude,e.primernombre,e.apellidopaterno,e.apellidomaterno,a.idaula,a.nombreaula,a.seccionid,i.fechainscripcion
                        ...
                        WHERE i.idinscripcion != 0 and a.seccionid = 2";
        $request = $this->select_all($sql);
        return $request;
    }

    public function registerInsKinder(int $estudianteid, int $aulaid, string $periodoid, string $fechainscripcion)
    {
        $return = "";
